...
import { LayoutTemplate, Menu, ArrowRight, X, LucidePlaneLanding, Zap, Download } from 'lucide-react';
        ...
        <main className={landingPageStyles.main}>
            ...
            <section className={landingPageStyles.featuresSection}>
                <div className={landingPageStyles.featuresContainer}>
                    <div className={landingPageStyles.featureHeader}>
                        <h2 className={landingPageStyles.featureTitle}>
                            Why Choose <span className={landingPageStyles.featuresTitleGradient}>Us</span>
                        </h2>
                        <p className={landingPageStyles.featureDescription}>
                            Everything you need to create a professtional resume that stands out
                        </p>
                    </div>
            ...
            <section className={landingPageStyles.ctaSection}>
                <div className={landingPageStyles.ctaContainer}>
                    <div className={landingPageStyles.ctaCard}>
                        <div className={landingPageStyles.ctaCardHover}></div>
                        <div className={landingPageStyles.ctaCardContent}>
                            ...
                            <p className={landingPageStyles.ctaDescription}>
                                Join thousands of professionals who landed their jobs with our platform
                            </p>
