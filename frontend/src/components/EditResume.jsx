...
const EditResume = () => {
    ...
    const uploadResumeImages = async () => {
        console.log('UPLOAD URL:', API_PATHS.RESUME.UPLOAD_IMAGES(resumeId));
        console.log('resumeId param:', resumeId);
        console.log('GET URL:', API_PATHS.RESUME.GET_BY_ID(resumeId));
        console.log('PUT URL:', API_PATHS.RESUME.UPLOAD_IMAGES(resumeId));
    ...
    const updateResumeDetails = async (thumbnailLink) => {
        try {
            setIsLoading(true)
            console.log('PUT URL:', API_PATHS.RESUME.UPDATE(resumeId));
    ...
    return (
        <DashboardLayout>
            ...
            <Modal isOpen={openPreviewModal} onClose={() => setOpenPreviewModal(false)} title={resumeData.title}
                showActionBtn actionBtnText={isDownloading ? "Downloading..." : downloadSuccess ? "Downloaded" : "Download PDF"}
